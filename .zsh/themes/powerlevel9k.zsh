...
#POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(vi_mode root_indicator context dir_writable dir vcs)
POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(vi_mode root_indicator dir_writable dir vcs)
